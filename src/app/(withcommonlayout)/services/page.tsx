  ...
  const services = [
    {
      ...
      isChoice: true,
      description:
        "I will create all kinds of graphic design for your projects",
      rating: 4.9,
      reviews: 45,
      startingPrice: 45,
    },
    {
      ...
      level: "Level 2",
      description:
        "I will be your graphic designer for any graphic design task",
      rating: 4.8,
      reviews: "1k+",
      startingPrice: 15,
    },
    {
      ...
      level: "Level 2",
      description:
        "I will be your graphic designer in adobe illustrator, coreldraw",
      rating: 4.9,
      reviews: 472,
      startingPrice: 15,
    },
    {
      ...
      level: "Level 2",
      description:
        "I will do any graphic design work using adobe photoshop, adobe illustrator",
      rating: 4.8,
      reviews: 87,
      startingPrice: 10,
    },
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem
              onSelect={() => addFilter("category", "Logo Design")}
            >
              Logo Design
            </DropdownMenuItem>
            <DropdownMenuItem
              onSelect={() => addFilter("category", "Web Design")}
            >
              Web Design
            </DropdownMenuItem>
            <DropdownMenuItem
              onSelect={() => addFilter("category", "Print Design")}
            >
              Print Design
            </DropdownMenuItem>
          </DropdownMenuContent>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DropdownMenuItem
              onSelect={() => addFilter("budget", "$25 to $50")}
            >
              $25 to $50
            </DropdownMenuItem>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem
              onSelect={() => addFilter("delivery", "24 Hours")}
            >
              24 Hours
            </DropdownMenuItem>
          ...
          <div key={service.id} className="group relative">
            ...
            <div className="mt-4">
              ...
              <div className="text-sm">
                From{" "}
                <span className="font-bold">US${service.startingPrice}</span>
              </div>
            </div>
          </div>
        ))}
