...
export default function FreelanceServiceCard({
  ...
  return (
    <Card className="w-full  mx-auto overflow-hidden transition-all duration-300">
      ...
      <CardContent className="px-4 space-y-1">
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-2">
            ...
            <div className="">
              <p className="font-semibold text-sm md:text-base text-">
                John Doe
              </p>
      ...
      <CardFooter className="py-2 bg-muted/50">
        <p className="text-xs md:text-sm font-medium text-muted-foreground text-right w-full">
          Delivery in 5 days
        </p>
      </CardFooter>
    </Card>
